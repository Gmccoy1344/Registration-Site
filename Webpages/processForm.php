...
$dogrid = mysqli_escape_string($conn,$_GET['ridInput']);
...
$sql_in = "INSERT INTO `owner` (`owner_id`, `catr_Id`, `dogr_Id`, `pet_Id`, `owner_name`, `owner_gender`, `email`, `phone`, `street`, `city`, `state`, `zip`) VALUES (NULL, NULL,'$dogrid', '$petid', '$name', '$gender', '$email', '$phone', '$street', '$city', '$state', '$zip' )";
